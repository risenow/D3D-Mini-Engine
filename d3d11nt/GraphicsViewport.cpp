...
GraphicsViewport::GraphicsViewport(const GraphicsSurface& surface, NumberRange<float> depthRange)
                                   : m_TopLeft(0, 0),
...
void GraphicsViewport::Set(GraphicsDevice& device)
{
