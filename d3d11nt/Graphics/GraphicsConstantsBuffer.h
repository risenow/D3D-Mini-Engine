...
template<class T>
class GraphicsConstantsBuffer : public GraphicsBuffer
{
public:
	...
	void Update(GraphicsDevice& device, T constants)
	{
		...
		device.GetD3D11DeviceContext()->UpdateSubresource(GetDX11Object(), 0, nullptr, &constants, sizeof(constants), 0);
	}
private:
};
