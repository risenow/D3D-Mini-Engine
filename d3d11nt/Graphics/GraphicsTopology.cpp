...
GraphicsTopology::GraphicsTopology(GraphicsDevice& device, ShadersCollection& shadersCollection, const ShaderStrIdentifier& shaderStrIdentifier, VertexData& data, GraphicsBuffer::UsageFlags usage, bool isBatch) : m_IsBatch(isBatch), m_IsValid(true), m_InputLayout(device, data.GetVertexFormat(), shadersCollection.GetShader<GraphicsVertexShader>(shaderStrIdentifier.path, shaderStrIdentifier.variation)),
